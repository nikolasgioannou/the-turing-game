...
The 48 presets cover loading, scores, offline and AI-capacity states, rules, role choices, queues, invitations, name entry, opening phases, live chat, low time, character limits, guessing, player waiting, results, interrupted games and rematch states. Add presets in `src/client/review/states.ts` as new UI states are introduced.
