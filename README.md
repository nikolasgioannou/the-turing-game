...
The bot uses Claude Haiku 4.5 with response planning, style analysis, draft handling, hedged
requests, normalization and pacing. It can send before the human and adapt to unsent drafts.
OpenRouter receives that context; application storage does not retain unsent drafts. See
[bot architecture and behavior](src/server/bot/README.md).
...
Browser tests use installed Chrome on this Mac. Model output is stochastic; behavior integrity is
